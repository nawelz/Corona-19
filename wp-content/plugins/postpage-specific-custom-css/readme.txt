...
This plugin requires at least WordPress <b>5.0</b> (never forget to update your WP installation!) and <b>PHP 5.6</b> installed on your server. It is pretty uncommon to offer previous versions of the PHP, however I must note that.
