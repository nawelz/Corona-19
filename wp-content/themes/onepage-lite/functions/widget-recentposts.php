...
class mts_recent_posts_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__('MTS Recent Posts', 'onepage-lite' ),
			array( 'description' => __( 'Display the most recent posts from all categories', 'onepage-lite' ) )
		);
	}
 	...
 	public function form( $instance ) {
		...
		$title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : __( 'Recent Posts', 'onepage-lite' );
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'onepage-lite' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id( 'qty' ); ?>"><?php _e( 'Number of Posts to show', 'onepage-lite' ); ?></label>
		...
		<p>
		   <label for="<?php echo $this->get_field_id( 'title_length' ); ?>"><?php _e( 'Title Length:', 'onepage-lite' ); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id("show_thumb2"); ?>">
				...
				<?php _e( 'Show Thumbnails', 'onepage-lite' ); ?>
			</label>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('box_layout'); ?>"><?php _e('Posts layout:', 'onepage-lite' ); ?></label>
			<select id="<?php echo $this->get_field_id('box_layout'); ?>" name="<?php echo $this->get_field_name('box_layout'); ?>">
				<option value="horizontal-small" <?php selected($box_layout, 'horizontal-small', true); ?>><?php _e('Horizontal', 'onepage-lite' ); ?></option>
				<option value="vertical-small" <?php selected($box_layout, 'vertical-small', true); ?>><?php _e('Vertical', 'onepage-lite' ); ?></option>
			</select>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id("date"); ?>">
				...
				<?php _e( 'Show post date', 'onepage-lite' ); ?>
			</label>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id("comment_num"); ?>">
				...
				<?php _e( 'Show number of comments', 'onepage-lite' ); ?>
			</label>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id("show_excerpt"); ?>">
				...
				<?php _e( 'Show excerpt', 'onepage-lite' ); ?>
			</label>
		</p>
		
		<p>
		   <label for="<?php echo $this->get_field_id( 'excerpt_length' ); ?>"><?php _e( 'Excerpt Length:', 'onepage-lite' ); ?>
				...
				<div class="post-img">
					<a href="<?php echo esc_url( get_the_permalink() ); ?>" title="<?php echo esc_attr( get_the_title() ); ?>">
						<?php if ( has_post_thumbnail() ) { ?>
							<?php the_post_thumbnail( 'onepage-lite-' . $thumbnail, array( 'title' => '' ) ); ?>
						<?php } else { ?>
							<img class="wp-post-image" src="<?php echo get_template_directory_uri() . '/images/nothumb-onepage-lite-' . $thumbnail . '.png'; ?>" alt="<?php echo esc_attr( get_the_title() ); ?>"/>
						<?php } ?>
					</a>
				</div>
				<?php endif; ?>
				<div class="post-data">
					<div class="post-data-container">
						...
						<div class="post-info">
							...
							<span class="thecomment"><?php echo comments_number(__('No Comment','onepage-lite'), __('One Comment','onepage-lite'), '<span class="comm">%</span> '.__('Comments','onepage-lite')); ?></span>
							<?php endif; ?>
						</div> <!--.post-info-->
						<?php endif; ?>
